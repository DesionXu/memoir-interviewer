...
- [x] AGC 创建应用：包名 com.dowson.memoir，App ID **6917613937982187251**（client_id 已配入 module.json5）
- [ ] 核对 AGC「项目设置 → 应用信息」的**客户端ID**是否与 App ID 相同（不同则发我更新）
- [ ] 开通语音服务：AGC → 构建 → API 管理 → 开通「语音识别」「语音合成」
