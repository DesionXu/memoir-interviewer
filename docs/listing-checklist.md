...
- [x] AGC 创建应用：包名 com.dowson.memoir，App ID 6917613937982187251，Client ID 2019266512988185600（已配入 module.json5）
- [ ] 语音服务开通（语音识别/语音合成）——暂缓，上架后再补；开通前语音功能会提示"引擎未就绪"，聊天/回忆录不受影响
- [ ] 生成 release 签名（发布类型不需要设备，见 docs/agc-setup-guide.md 第三节）并构建发布包
- [ ] 上传发布包到 AGC 并提交审核（含隐私政策、截图、软著、备案号）
